        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Masukan Informasi Cabang</h5>
                ...
                <form wire:submit.prevent="save" id="form_add">
                    <div class="modal-body">
                        ...
                        <div class="mb-10">
                            ...
                            <textarea id="email" class="form-control form-control-solid" wire:model="address"></textarea>
                            @error('address')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
...
<script>
    window.addEventListener('contentChange', event => {
        ...
        Livewire.on('onClickUpdate', (item) => {
            @this.set('cabang_id', item.id)
            @this.set('name', item.name)
            @this.set('address', item.address)

                                    ...
                                    <div class="d-flex align-items-center mb-8">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mx-5">
                                            <input class="form-check-input" type="checkbox" value="{{ $i->item_id }}"
                                                wire:change="updateQty({{ $i->item_id }})" wire:model="listProduk">
                                        </div>
                                        <!--end::Checkbox-->
                                        <!--begin::Description-->
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="input-group input-group-sm justify-content-end">
                                                ...
                                                <input type="number" class="form-control"
                                                    ...
                                                    wire:change="onSum" @if(!in_array($i->item_id,$listProduk)) disabled
                                                @endif
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body d-flex justify-content-end">
                                <span style="font-size: 24px; font-weight: bold;">Rp. <span id="totalPrice"
                                        class="badge badge-success" style="font-size: 24px; font-weight: bold;">{{
                                        $total }}</span></span>
                            </div>
                        </div>
